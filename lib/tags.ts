...
/** Get tag definitions for the create page (includes id, name, nameSv) */
export function getTagsForUI(): { id: string; name: string; nameSv: string }[] {
  return TAG_DEFINITIONS.map((t) => ({ id: t.id, name: t.name, nameSv: t.nameSv }));
}
